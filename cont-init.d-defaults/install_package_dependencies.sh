...
if [ ! -z "${PACKAGE_DEPENDENCIES}" ] ; then
	...
	echo "R_PACKAGES ENV variable value: '$R_PACKAGES' matched none of the rules do no package prerequisites were installed. Set to ALL to match all rules or check README.md at $SOURCE_REPO for more options"
fi